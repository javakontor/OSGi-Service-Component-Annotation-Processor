...
public class DsXmlExporter {
  ...
  public DsXmlExporter() {
    component = new org.jdom.Element("component", Namespace.getNamespace("scr", "http://www.osgi.org/xmlns/scr/v1.1.0"));
  }
  ...
  public void exportXml(ProcessingEnvironment processingEnv) {
    ...
    try {
      ...
      fmt.output(doc, os);
      processingEnv.getMessager().printMessage(Diagnostic.Kind.NOTE, "DsAnnotationProcessor erzeugt: " + fo.toUri());
  ...
  public void addReference(String serviceInterface, String policy, String cardinality, String target, String name,
  ...
  /**
   * Adds the specified attribute to the given element if the attribute's value is an non-empty string
   * 
   * @param element
   *          the element
   * @param attribute
   ...
   * @param value
   *          the value of the attribute. If null or empty string the attribute will not be added to the element
   */
  private void addAttributeIfNotEmpty(org.jdom.Element element, String attribute, String value) {
