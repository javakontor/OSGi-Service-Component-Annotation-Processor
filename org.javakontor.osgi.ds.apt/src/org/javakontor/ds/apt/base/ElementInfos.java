...
public class ElementInfos {
	...
	public ElementInfos(Element element) {
		for (AnnotationMirror mirror : element.getAnnotationMirrors()) {
			final String currentAnnotationType = mirror.getAnnotationType().toString();
			Class annotationType;
			try {
				annotationType = Class.forName(currentAnnotationType);
				Annotation annotation = element.getAnnotation(annotationType);
				annotations.put(currentAnnotationType, new AnnotationInfos(annotation, mirror));
	...
	public AnnotationInfos getAnnotationInfos(Class<? extends Annotation> annotationType) {
