		...
		if (designateType != null) {
			metaData =
				new org.jdom.Element(
					"MetaData",
					Namespace.getNamespace("metatype", "http://www.osgi.org/xmlns/metatype/v1.1.0")
				);
...
//          System.out.println("Unbekannter Type für: " + element + ": " + typeName);
		}
